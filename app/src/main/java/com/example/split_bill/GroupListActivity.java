...
public class GroupListActivity extends AppCompatActivity {
    ...
    private List<com.example.split_bill.GroupEntity> groupNames = new ArrayList<>();
    private com.example.split_bill.GroupListActivityViewAdapter adapter;
    private com.example.split_bill.GroupViewModel groupViewModel;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new com.example.split_bill.GroupListActivityViewAdapter(GroupListActivity.this);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setAdapter(adapter);

        // if data in database(Group) changes, call the onChanged() below
        groupViewModel = new ViewModelProvider(this).get(com.example.split_bill.GroupViewModel.class);
        groupViewModel.getAllGroups().observe(this, new Observer<List<com.example.split_bill.GroupEntity>>() {
            @Override
            public void onChanged(List<com.example.split_bill.GroupEntity> groupEntities) {
        ...
        adapter.setOnItemClickListener(new com.example.split_bill.GroupListActivityViewAdapter.OnGroupClickListener() {
            @Override
